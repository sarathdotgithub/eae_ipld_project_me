...
st.set_page_config(
    page_title="Sarathraj Jawahar Portfolio",
    page_icon="📊",
)
...
def home_page():
    ...
    # ----- Profile image file -----
    profile_image_file_path = "sarath_image_1.jpg"       # TODO: Upload your profile image to the same folder as this script and update this if it has a different name
    ...
    <div style="display: flex; justify-content: center;">
        <img src="{img}" alt="sarath_image_1" width="450" height="525" style="border-radius: 50%; object-fit: cover; margin-top: 40px; margin-bottom: 40px;">
    </div>
    """)
    ...
    st.write("""
    - 🧑‍💻 I am studying Master's in Big Data and Analytics

    - 🛩️ prev: Data Analyst, Mechanical engineer

    - ❤️ sports,hiking

    - 🤖 https://github.com/sarathdotgithub/ADVENTURE-WORKS

    - 🏂 Running,gym,bicing,Internationl affairs

    - 📫 How to reach me: sjawahar@student.eae.es
